...
export const COVER_LETTER_TEMPLATES: TemplateDefinition[] = [
  {
    id: 'formal_id',
    name: 'Surat Lamaran Formal (Indonesia)',
  ...
  {
    id: 'professional_en',
    name: 'Professional English Cover Letter',
    badge: 'International / Corporate',
    description: 'Structured corporate format with strong impact paragraphs for multinational & remote companies.',
    language: 'en',
  },
  {
    id: 'email_short',
    name: 'Body Email Lamaran Kerja',
    badge: 'Siap Kirim Email',
    description: 'Format padat & ringkas yang dapat langsung disalin ke badan email saat mengirim lampiran CV ke HRD.',
    language: 'id',
  },
  {
    id: 'creative',
    name: 'Creative & Tech Startup Pitch',
    badge: 'Modern & Startup',
    description: 'Gaya penulisan dinamis yang berfokus pada hasil karya, inisiatif, dan keselarasan visi dengan perusahaan.',
    language: 'id',
  },
]
